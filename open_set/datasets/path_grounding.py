...
@DATASETS.register_module()
class PathGroundOpenWithAllClasses(CocoDatasetOpen):
    """A dataset that generates other the segmentation mask for grounding or captioning data.
    ...
    Reference:
        https://www.youtube.com/watch?v=jftZBfMZj8k
    """
    CLASSES =  ('neoplastic', 'inflammatory', 'connective', 'dead', 'epithelial', 'mitotic figure', 
                'cell', 'stain', 'tumor', 'lesion', 'duct', 'nerve', 'blood vessel', 'gland', 'structure', 
                'nucleolus', 'pigment', 'lymphocyte', 'basal cell', 'columnar cell', 'artery', 'adipocyte', 'glomerulus',
            )
    def __init__(
        self,
        ann_file: str,
