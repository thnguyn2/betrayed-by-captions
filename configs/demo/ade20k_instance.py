...
class_to_emb_file = f'../datasets/embeddings/ade20k_instance_class_with_bert_emb.json'
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/ade20k_instances_val.json',
...
workflow = [('train', max_epochs), ('val', 0)]
checkpoint_config = dict(
    by_epoch=True, interval=max_epochs, save_last=True, max_keep_ckpts=3)
