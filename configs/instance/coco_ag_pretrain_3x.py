...
known_file = f'./datasets/unknown/known_65.txt'
unknown_file = f'./datasets/unknown/unknown_17.txt'
...
model = dict(
    ...
    train_cfg=dict(
        ...
        assigner=dict(
            ...
            cls_emb_cost=dict(type='ClassificationCost', weight=0.0),
            mask_cost=dict(
...
train_pipeline = [
    ...
    dict(type='LoadOpenAnnotations', with_bbox=True, with_mask=True),
...
checkpoint_config = dict(
    by_epoch=True, save_last=True, max_keep_ckpts=3)
